...
const darkDefaultThemeViniam = getTheme({
  theme: "dark",
  name: "GitHub Dark Default Viniam",
});
...
fs.mkdir("./themes", { recursive: true })
  .then(() => Promise.all([
    ...
    fs.writeFile("./themes/dark-default-viniam.json", JSON.stringify(darkDefaultThemeViniam, null, 2)),
